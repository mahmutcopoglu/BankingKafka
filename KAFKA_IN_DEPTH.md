...
konfigurasyonu false yaparak eğer işlem başarılı ise ben kafkaya açıkca mesajı işledim, offsetimi güncelle diyeceğim demiş oluyoruz. Bu durumda mesajları başarılı şekilde işledikten sonra
```
    consumer.commitSync();
```
